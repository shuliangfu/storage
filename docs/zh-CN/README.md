...
## [![JSR](https://jsr.io/badges/@dreamer/storage)](https://jsr.io/@dreamer/storage) [![License: Apache-2.0](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](../../LICENSE)
...
**v1.0.0**（2026-02-19）：首个稳定版。服务端：FileStorage、KeyValueStorage、FileStorageAdapter、StorageManager、createStorageManager、@dreamer/service
集成。客户端：BrowserStorage、KeyValueStorage（浏览器）、localStorage/sessionStorage/IndexedDB
适配器。完整历史见 [CHANGELOG.md](./CHANGELOG.md)。
